...
/*
O arquivo cliente.php foi será incluido para que a classe cliente 
seja usada. Vale lembrar que esta classe possui o CRUD
*/
include_once "../../domain/armasigma.php";
...
/*
Vamos fazer uma instância da classe cliente para ter acesso a todo
o seu conteúdo.
*/

$armasigma = new armasigma($db);
...
if($rs->rowCount()>0){
    $armasigma_arr["saida"] = array();
/*
A estrutra while(equanto) realiza a busca de todos os armasigma cadastrados
até chegar ao final da tabela e tras os dados para fetch array organizar 
em formato de array
Assim será mais fácil de adcionar no array de armasigma para apresentar 
ao final
*/
